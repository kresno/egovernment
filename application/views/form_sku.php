<section style="padding: 30px">
 ...
 <div class="main">  
  ...
  <li><a href="<?php echo base_url ('sku') ?>">SKU</a></li>
           ...
           <div class="page-header" style="margin-top:20;margin-bottom:20px;">
             <div class="sign-body">
               ...
               <div class="formulir_bottom">
                 ...
                 <form name='formulir_domisili' method='post' id='formulir' enctype='multipart/form-data' action="<?php echo base_url('sku/data_user');?>">
              ...
              <input type="text"  id="tgl_lahir" name="tgl_lahir" value="<?php echo $data_user[0]['tgl_lahir']?>" disabled>
                ...
                <p>
                  ...
                  <input type='text' name='nama_perusahaan' id='nama_perusahaan' placeholder="Contoh: PT. Mobil Baru"required/>
                </p>

                <p>
                  <label>Jenis Usaha</label>
                  <input type='text' name='jenis_usaha' id='jenis_usaha' placeholder="Contoh: Jual Beli Mobil" required/>
                </p>
                <p>
                  <label>Alamat Tempat Usaha</label>
                  <input type='text' name='alamat_usaha' id='alamat_usaha' placeholder="Contoh: Ruko Delapan No. 3 Ciluar" required/>
                </p>
