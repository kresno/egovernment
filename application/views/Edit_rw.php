<section id="main-content">
  ...
  <div class="col-md-12 mt">
      ...
      <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/Edit_instansi_model/update');?>"> 
       <!-- text input -->
      ...
      <div class="form-group">
        ...
        <input name="instansi" type="text" class="form-control"  value="<?php echo $row['instansi'];?>" disabled> 
        </div>
      <p>
