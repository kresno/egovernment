    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="<?php echo base_url('home')?>"=>Kecamatan Bogor Utara</a>
            </div>
            ...
            <ul class="nav navbar-nav navbar-right" >
                    ...
                    <li class="page-scroll">
                        <a href="<?php echo base_url('home/bantuan')?>" style="color:white"><i class="fa fa-question-circle fa-2x"></i>&nbsp; Bantuan</a>
                    </li>
