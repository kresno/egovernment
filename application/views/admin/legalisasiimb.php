  ...
  <section class="wrapper">
    ...
    <div class="col-md-12 mt">
      <div class="content-panel"style="padding-left: 10px">
        <h4><i class="fa fa-angle-right"></i> Verifikasi IMsdB</h4>
        <hr>
        <thead>
          ...
          <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/Edit_imb/updatelegal');?>"> 
           <!-- text input -->
           <input  name="id_simb" type="hidden" class="form-control"  value="<?php echo $row['id_simb'];?>" readonly>
