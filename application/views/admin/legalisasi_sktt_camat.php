          ...
          <section class="wrapper">
					...
					<div class="table-responsive">
                      <div class="content-panel">
                            <h4><i class="fa fa-angle-right"></i> Surat Keterangan Tempat Tinggal</h4>
                            <hr>
      ...
      <table id="myTable" class="table table-striped table-advance table-hover">
        ...
        $nik=$row['nik']; 
          ...
          <td><?php $originalDate = $row['tgl_camat']; $newDate = date("d-m-Y", strtotime($originalDate)); if($newDate=='01-01-1970') echo "-"; else echo $newDate; ?> </td>
           <td ><a href="<?php echo base_url()."Admin/Admin_sktt/Lihat/";echo $row['id_sktt'] ?>"> <i class="glyphicon glyphicon-eye-open"> </i> </a></td>
          
            <td ><a href="<?php echo base_url()."Admin/Admin_sktt/cetak/";echo $row['nik'] ?>"> <i class="glyphicon glyphicon-print"> </i> </a></td>
          ...
          if($row['legalisasi_camat'] == "Y"){
            ...
            ?>
            <td>
                <a href="<?php echo base_url()."Admin/Admin_sktt/legalisasicamat/";echo $row['id_sktt'] ?>" class="btn btn-primary"> 
            Legalisasi</a>
