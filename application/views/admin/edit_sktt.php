<section id="main-content">
  ...
  <div class="col-md-12 mt">
      ...
      <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/Edit_sktt/updatelegal');?>"> 
       <!-- text input -->
      ...
      <div class="form-group">
        ...
        <input  name="file_ktp" type="text" class="form-control"  value="<?php echo $row['file_ktp'];?>" >
      </div>
      <div class="form-group">
        <label>File KK</label>
        <img src="<?php echo base_url('./uploads/SKTT/KK/'.$row['file_kk']); ?>" height="100px">
        <input name="file_kk" type="text" class="form-control"  value="<?php echo $row['file_kk'];?>" >
      </div>
      <div class="form-group">
