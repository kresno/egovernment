<section id="main-content">
  ...
  <div class="col-md-12 mt">
                      <div class="content-panel" style="padding-left: 10px">
                            <h4><i class="fa fa-angle-right"></i>aaaLegalisasi Surat Keterangan Tempat Tinggal</h4>
                            <hr>
                                <thead>
      ...
      <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/Edit_sktt/updatelegallurah');?>"> 
       <!-- text input -->
