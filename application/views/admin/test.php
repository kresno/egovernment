...
<table>
	...
	<tr>
	  <td colspan="3"><p align="justify">Demikian Surat Keterangan Domisili Perusahaan ini dibuat untuk dapat dipergunakan sebagaimana mestinya dan <br/> berlaku sampai dengan tanggal <?php $originalDate =  $row['tgl_camat']; $newDate = date("d-m-Y", strtotime($originalDate)); echo $newDate; ?>.</p></td>
    </tr>
</table>
