 <html>
      ...
      <table id="myTable" class="table table-striped table-advance table-hover">
          ...
          <tr>
          <td><?php echo $no ?> </td>
          <td><?php echo $row['nama_yayasan'] ?> </td>
        ...
        <td><?php $originalDate = $row['tgl_camat']; $newDate = date("d-m-Y", strtotime($originalDate)); if($newDate=='01-01-1970') echo "-"; else echo $newDate; 
            ?> </td>
          ...
          if($row['legalisasi_lurah'] == "Y"){
            ...
            ?>
            <td>
                <a href="<?php echo base_url()."Admin/Admin_ho/legalisasilurah/";echo $row['id_siho'] ?>" class="btn btn-primary"> 
            Legalisasi</a>
