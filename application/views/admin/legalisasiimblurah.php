<section id="main-content">
  ...
  <div class="col-md-12 mt">
      ...
      <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/Edit_imb/Updatelegallurah');?>"> 
       <!-- text input -->
        
       <input  name="id_simb" type="hidden" class="form-control" value="<?php echo $row['id_simb'];?>" >
       <div class="form-group">
        <label>Tanggal Daftar
        <input  name="tgl_daftar" type="date" class="form-control"  value="<?php echo $row['tgl_daftar'];?>" readonly >
           </label>
            </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label>File KTP</label><br/>
         <a href="<?php echo base_url('/uploads/IMB/ktp/'.$row['file_ktp']); ?>">
          <img src="<?php echo base_url('/uploads/IMB/ktp/'.$row['file_ktp']); ?>" height="100px">
          </a>
