...
<!--                                <form method=POST action='' target=_blank>-->
      ...
      <td ><a href="<?php echo base_url()."Admin/Admin_skdu/cetak/";echo $row['nik'] ?>"> <i class="glyphicon glyphicon-print"> </i> </a></td>
        ...
        <?php
          ...
          if($row['legalisasi_camat'] == "Y"){
            ...
            ?>
            <td>
                <a href="<?php echo base_url()."Admin/Admin_imb/legalisasicamat/";echo $row['id_simb'] ?>" class="btn btn-primary"> 
            Legalisasi</a>
