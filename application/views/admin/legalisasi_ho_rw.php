      ...
      <table id="myTable" class="table table-striped table-advance table-hover">
        ...
        $nik=$row['nik']; 
          ...
          <td><?php echo $row['tgl_camat'] ?> </td>
           <td ><a href="<?php echo base_url()."Admin/Admin_siho/Lihat/";echo $row['id_siho'] ?>"> <i class="glyphicon glyphicon-eye-open"> </i> </a></td>
          ...
          if($row['legalisasi_rt'] == "Y" && $row['legalisasi_rw'] == "Y"){
            ?>
            <td ><a href="<?php echo base_url()."Admin/Admin_ho/legalisasirw/";echo $row['id_siho'] ?>"> 
