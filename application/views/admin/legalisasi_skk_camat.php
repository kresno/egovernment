...
<div id="page-inner">
                    ...
                    <div class="col-md-12 mt">
                      <div class="content-panel">
                            <h4><i class="fa fa-angle-right"></i> Surat Keterangan Kematian</h4>
                            <hr>
        ...
        $nik=$row['nik']; 
         ...
         <td><?php $originalDate = $row['tgl_daftar']; $newDate = date("d-m-Y", strtotime($originalDate)); echo $newDate; ?> </td>
          ...
          <td><?php $originalDate = $row['tgl_camat']; $newDate = date("d-m-Y", strtotime($originalDate)); if($newDate=='01-01-1970') echo "-"; else echo $newDate; ?> </td>
           <td ><a href="<?php echo base_url()."Admin/Admin_skk/Lihat/";echo $row['id_skk'] ?>"> <i class="glyphicon glyphicon-eye-open"> </i> </a></td>
         
            <td ><a href="<?php echo base_url()."Admin/Admin_skk/cetak/";echo $row['nik'] ?>"> <i class="glyphicon glyphicon-print"> </i> </a></td>
          ...
          if($row['legalisasi_camat'] == "Y"){
            ...
            ?>
            <td>
                <a href="<?php echo base_url()."Admin/Admin_skk/legalisasicamat/";echo $row['id_skk'] ?>" class="btn btn-primary"> 
            Legalisasi</a>
