...
<div id="page-inner">
					...
					<div class="table-responsive">
                      <div class="content-panel">
                            <h4><i class="fa fa-angle-right"></i> Kartu Tanda Penduduk</h4>
                            <hr>
      ...
      <table id="myTable" class="table table-striped table-advance table-hover">
        ...
        $nik=$row['nik']; 
          ...
          <td><?php $originalDate = $row['tgl_camat']; $newDate = date("d-m-Y", strtotime($originalDate)); if($newDate=='01-01-1970') echo "-"; else echo $newDate; ?> </td>
           <td ><a href="<?php echo base_url()."Admin/Admin_ktp/Lihat/";echo $row['id_ktp'] ?>"> <i class="glyphicon glyphicon-eye-open"> </i> </a></td>
         <td ><a href="<?php echo base_url()."Admin/Admin_ktp/cetak/";echo $row['nik'] ?>"> <i class="glyphicon glyphicon-print"> </i> </a></td>
          ...
          if($row['legalisasi_camat'] == "Y"){
            ...
            ?>
            <td>
                <a href="<?php echo base_url()."Admin/Admin_ktp/legalisasicamat/";echo $row['id_ktp'] ?>" class="btn btn-primary"> 
            Legalisasi</a>
