<section style="padding: 70px">
 ...
 <div class="main">  
  ...
  <li class="active">Surat Keterangan Usaha</li>
        ...
        <center><h3>Surat Keterangan Usaha</h3></center>
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="retribusi"  style="padding-left: 10px">
                <div class="page-header" style="margin-top:0;margin-bottom:20px;"><h4>Silahkan Login Untuk Mengajukan Surat</h4>
                  <div class="sign-body">
                    <form onSubmit="return cekField()" name="cekForm" method="POST" action="<?php echo base_url('Sku/validasi');?>">
                      <div class="form-group">
                        <div class="form-group field-register-form-nik">
                          <label class="control-label" for="register-form-nik">NIK</label>
                          <input type="text" id="register-form-nik" class="form-control" name="f1" placeholder="NIK" maxlength="16" width="25pt" required>
          ...
          <div class="tab-pane fade" id="deskripsi"  style="padding-left: 20px">
            <div class="deskripsi">
              <br>
              <p style="text-align: justify;font-size: 11pt">Surat keterangan usaha (SKU) adalah surat yang mendeskripsikan suatu perusahaan secara rinci.</p> </div>
            </div>
            <div class="tab-pane fade" id="alur" style="padding-left: 10px">
              <br>
              <p><strong>Tata Cara Pembuatan SKU</strong></p>
                <li>Membuat Surat Pengantar RT/RW</li>
                <li>Datang ke Kantor Kelurahan/Kepala Desa</li>
                <li>isi formulir pembuatan Surat Keterangan Usaha.</li>
                <li>Proses pembuatan surat akan memakan waktu.</li>
                <li>Surat memerlukan legalsasi dari pihak kecamatan</li>
                <li>Surat dapat diambil di Kecamatan apabila sudah melalui semua Proses.</li>
            </div>
            <div class="tab-pane fade" id="persyaratan" style="padding-left: 10px">
              <br>
              <p><strong>Berkas-berkas yang harus dipenuhi untuk pembuatan SKU</strong></p>
