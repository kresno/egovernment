...
<head>
  <title>Home - Sistem Pelayanan Publik</title>
...
<head>
    ...
    <title>Kecamatan Bogor Utara</title>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom" style="background-color: #2C3E50">
        <div class="container">
            ...
            <div class="navbar-header page-scroll" >
                ...
                <a class="navbar-brand" href="<?php echo base_url('home')?>" style="color:white">Kecamatan Bogor Utara</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right" >
                    ...
                    <li class="page-scroll">
                        <a href="<?php echo base_url('home/pejabat')?>" style="color:white">Kepala Camat</a>
                    </li>
                    <li class="page-scroll">
                        <a href="<?php echo base_url('home/stuktur_organisasi')?>" style="color:white">Stuktur Organisasi</a>
                    </li>
